...
public class ChucNangServiceImpl implements ChucNangService {
	...
	@Override
	public List<ChucNang> findByTenchucnangContainingIgnoreCase(String tenchucnang) {
		return chucNangRepository.findByTenchucnangContainingIgnoreCase(tenchucnang);
	}
