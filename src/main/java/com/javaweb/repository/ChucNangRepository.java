...
public interface ChucNangRepository extends JpaRepository<ChucNang, Long>{
	...
	@Query(value = "SELECT id, machucnang, tenchucnang, maapi, createday, nguoitao, updateday, nguoiupdate, parentid, isdelete FROM qtht_chucnang WHERE isdelete = 0 order by id", nativeQuery = true)
	...
	List<ChucNang> findChucnangByTennguoidung(String tennguoidung, String tennguoidung1);
